...
// esta noutra maquina e so chega a porta por 0.0.0.0: detecta-se pela RENDER, que o
// Render define sozinho, e HOST sobrepoe-se a tudo.
const soLocal = ehProducao && !env.RENDER;
const host = env.HOST ?? (soLocal ? '127.0.0.1' : '0.0.0.0');
