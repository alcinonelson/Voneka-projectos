...
import { COR, FONTE,
  MARCA, LARGURA, PESO, RAIO, SOMBRA, cartao, numerico, textoTruncado } from '../design/tokens';
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
        ...
        <span style={{ fontSize: FONTE.base, fontWeight: PESO.medio, marginLeft: 8 }}>{rotuloJanela}</span>
      ...
      <div style={{ ...cartao, overflow: 'hidden' }}>
        ...
        >
          <div style={{ width: LARGURA.roteiroNomes, flex: `0 0 ${LARGURA.roteiroNomes}px` }} />
          ...
          linhas.map(({ projecto, fases }, indiceLinha) => {
            return (
              ...
              >
                <div
                  style={{
                    width: LARGURA.roteiroNomes,
                    flex: `0 0 ${LARGURA.roteiroNomes}px`,
                ...
                >
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: FONTE.corpo, fontWeight: PESO.medio, ...textoTruncado }}>
                      {projecto.nome}
                    </div>
